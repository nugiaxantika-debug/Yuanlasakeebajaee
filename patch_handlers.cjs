...
// Let's insert handlers right before } else if (body.startsWith(".pinterest ") || body === ".pinterest" || body.startsWith("pinterest ") || body === "pinterest") {
code = code.replace(
  /    \} else if \(body\.startsWith\("\.pinterest "\) \|\| body === "\.pinterest" \|\| body\.startsWith\("pinterest "\) \|\| body === "pinterest"\) \{/,
  handlers + "\n    } else if (body.startsWith(\".pinterest \") || body === \".pinterest\" || body.startsWith(\"pinterest \") || body === \"pinterest\") {"
);
