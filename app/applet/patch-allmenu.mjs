...
const originalAllmenuBlock = `      if (this.coverImageBuffer) {
...
const newAllmenuBlock = `      if (this.channelLink) {
...
if (c.includes('if (this.coverImageBuffer) {\n        await this.sock.sendMessage(jid, { image: this.coverImageBuffer, caption: menu }, { quoted: msg });')) {
  c = c.replace(originalAllmenuBlock, newAllmenuBlock);
